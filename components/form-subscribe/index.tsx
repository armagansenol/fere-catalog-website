        ...
        <div className={cx(s.row)}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className={s.formItem}>
                  {/* <FormLabel className={s.formLabel}>Ad Soyad</FormLabel> */}
                  <FormControl>
          ...
          <div className={s.fieldC}>
            <FormField
              ...
              render={({ field }) => (
                <FormItem className={s.formItem}>
                  {/* <FormLabel className={s.formLabel}>E-posta</FormLabel> */}
                  <FormControl>
        ...
        <div className={cx(s.row, "flex")}>
          <div className={s.fieldC}>
            <FormField
              ...
              render={({ field }) => (
                <FormItem className={s.formItem}>
                  {/* <FormLabel className={s.formLabel}>Cep Telefonu*</FormLabel> */}
